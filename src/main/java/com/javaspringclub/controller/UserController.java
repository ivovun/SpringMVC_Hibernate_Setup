...
public class UserController {
	...
	@RequestMapping(value = { "/", "/allUsers" }, method = RequestMethod.GET, produces = "text/plain;charset=UTF-8")
	...
	// Get All Users
	@RequestMapping(value = "/allUsers", method = RequestMethod.POST, produces = "text/plain;charset=UTF-8")
...
//			mv.addObject("message", "New user successfully added");
	...
	@RequestMapping(value = "/editUser/{id}", method = RequestMethod.GET, produces = "text/plain;charset=UTF-8")
	...
	@RequestMapping(value = "/editUser/{id}", method = RequestMethod.POST, produces = "text/plain;charset=UTF-8")
	...
	@RequestMapping(value = "/deleteUser/{id}", method = RequestMethod.GET, produces = "text/plain;charset=UTF-8")
